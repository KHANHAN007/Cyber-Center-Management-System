...
public class PCManagementHandler {
        ...
        public void handlePCManagement() {
                while (true) {
                        ...
                        ConsoleUtils.printCenter(
                                        ConsoleUtils.CYAN + "━━━━━━━━ ＰＣ ＭＡＮＡＧＥＭＥＮＴ ━━━━━━━━" + ConsoleUtils.RESET,
        ...
        private void handlePCConfigManagement() {
                while (true) {
                        ...
                        ConsoleUtils.printLogoCentered(logo, 147, 70);
                        ConsoleUtils.printCenter(
                                        ConsoleUtils.CYAN + "━━━━━ ＰＣ ＣＯＮＦＩＧ ＭＡＮＡＧＥＭＥＮＴ ━━━━━" + ConsoleUtils.RESET,
                                        ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println();
                        ...
                        System.out.print(
                                        centerText(
                                                        ConsoleUtils.YELLOW + "Choose an option (1-3): "
                                                                        + ConsoleUtils.RESET,
                                                        ConsoleUtils.DEFAULT_WIDTH));
        ...
        private void viewAllPCs() {
                try {
                        ...
                        ConsoleUtils.printCenter(ConsoleUtils.CYAN + "━━━━━━━━ ＰＣ  ＬＩＳＴ ━━━━━━━━" + ConsoleUtils.RESET,
                                        ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println();

                        String[] headers = { "ID", "PC Code", "Zone", "Status", "Config" };
                        int[] columnWidths = { 5, 20, 15, 15, 15 };
                        ...
                        if (pcs != null && !pcs.isEmpty()) {
                                for (int i = 0; i < pcs.size(); i++) {
                                        ...
                                        String[] row = {
                                                        ...
                                                        pc.getPcCode(),
                                                        String.valueOf(pc.getZone().getZoneName()),
        ...
        private void addNewPC() {
                try {
                        ...
                        ConsoleUtils.printLogoCentered(logo, 147, 70);
                        ConsoleUtils.printCenter(ConsoleUtils.CYAN + "━━━━━━━━ ＡＤＤ  ＮＥＷ  ＰＣ ━━━━━━━━" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println();

                        System.out.print(centerText(ConsoleUtils.YELLOW + "PC Name: " + ConsoleUtils.RESET,
                                        ConsoleUtils.DEFAULT_WIDTH));
                        String pcName = sc.nextLine().trim();

                        if (pcName.isEmpty()) {
                                ConsoleUtils.printCenter(ConsoleUtils.RED + "PC Name cannot be empty!" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                                System.out.print(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                                sc.nextLine();
                                return;
                        }

                        System.out.print(centerText(ConsoleUtils.YELLOW + "Zone ID: " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        int zoneId = Integer.parseInt(sc.nextLine().trim());

                        System.out.print(centerText(ConsoleUtils.YELLOW + "Config ID: " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        ...
                        System.out.println();
                        ConsoleUtils.printCenter(ConsoleUtils.GREEN + "PC added successfully!" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        sc.nextLine();
                } catch (NumberFormatException e) {
                        ConsoleUtils.printCenter(ConsoleUtils.RED + "Invalid input format!" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        sc.nextLine();
                } catch (Exception e) {
                        ConsoleUtils.printCenter(ConsoleUtils.RED + "Error: " + e.getMessage() + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        sc.nextLine();
                }
        }
        ...
        private void viewPCDetail() {
                try {
                        ...
                        ConsoleUtils.printCenter(ConsoleUtils.CYAN + "━━━━━━━━ ＰＣ  ＤＥＴＡＩＬＳ ━━━━━━━━" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println();

                        System.out.print(centerText(ConsoleUtils.YELLOW + "Enter PC ID: " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        ...
                        if (pcDetail != null) {
                                ...
                                System.out.println();
                                ConsoleUtils.printCenter(ConsoleUtils.RED + "PC not found!" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        }

                        System.out.println(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        sc.nextLine();
                } catch (NumberFormatException e) {
                        ConsoleUtils.printCenter(ConsoleUtils.RED + "Invalid PC ID format!" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.print(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        sc.nextLine();
                } catch (Exception e) {
                        ConsoleUtils.printCenter(ConsoleUtils.RED + "Error: " + e.getMessage() + ConsoleUtils.RESET,ConsoleUtils.DEFAULT_WIDTH);
        ...
        private void addPCConfig() {
                try {
                        ...
                        ConsoleUtils.printCenter(ConsoleUtils.CYAN + "━━━━━━━━ ＡＤＤ  ＰＣ  ＣＯＮＦＩＧ ━━━━━━━━" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println();

                        System.out.print(centerText(ConsoleUtils.YELLOW + "CPU: " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        String cpu = sc.nextLine().trim();

                        System.out.print(centerText(ConsoleUtils.YELLOW + "RAM (GB): " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        int ram = Integer.parseInt(sc.nextLine().trim());
                        System.out.print(centerText(ConsoleUtils.YELLOW + "GPU: " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        String gpu = sc.nextLine().trim();
                        System.out.print(centerText(ConsoleUtils.YELLOW + "Price per Hour (VND): " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        double price = 0;
                        ...
                        while (!validPrice) {
                                try {
                                        ...
                                        if (price < 0) {
                                                ConsoleUtils.printCenter(ConsoleUtils.RED + "Price cannot be negative! Please try again." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                                                System.out.print(centerText(ConsoleUtils.YELLOW + "Price per Hour (VND): " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                                        } else {
                                                validPrice = true;
                                        }
                                } catch (NumberFormatException e) {
                                        ConsoleUtils.printCenter(ConsoleUtils.RED + "Invalid price format! Please enter a valid number." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                                        System.out.print(centerText(ConsoleUtils.YELLOW + "Price per Hour (VND): " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                                }
                        }
                        ...
                        System.out.println();
                        ConsoleUtils.printCenter(ConsoleUtils.GREEN + "PC Config added successfully!" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                        sc.nextLine();
                } catch (NumberFormatException e) {
                        ConsoleUtils.printCenter(ConsoleUtils.RED + "Invalid input format!" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
        ...
        private void updatePCStatus() {
                try {
                        ...
                        ConsoleUtils.printLogoCentered(logo, 147, 70);
                        ConsoleUtils.printCenter(ConsoleUtils.CYAN + "━━━━━━━━ ＵＰＤＡＴＥ  ＰＣ  ＳＴＡＴＵＳ ━━━━━━━━" + ConsoleUtils.RESET,
                                        ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println();
                        ...
                        while (!statusSelected) {
                                ...
                                System.out.println(centerText(ConsoleUtils.YELLOW + "Enter new status (1-5): " + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                                ...
                                switch (choice) {
                                        ...
                                        case 5:
                                                System.out.println();
                                                ConsoleUtils.printCenter(ConsoleUtils.CYAN + "Operation cancelled" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                                                System.out.println(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                                                sc.nextLine();
                                                return;
                                        default:
                                                System.out.println();
                                                ConsoleUtils.printCenter(ConsoleUtils.RED + "Invalid choice!" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                                                System.out.println(centerText(ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH));
                                                sc.nextLine();
                                                System.out.println();
                                                ConsoleUtils.clearScreen();
                                                ConsoleUtils.printLogoCentered(logo, ConsoleUtils.DEFAULT_WIDTH, 68);
                                                ConsoleUtils.printCenter(ConsoleUtils.CYAN + "Update PC Status" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                                                System.out.println();
                                                ConsoleUtils.printCenter(
                                                                ConsoleUtils.CYAN + fullInfo + ConsoleUtils.RESET,
                                                                ConsoleUtils.DEFAULT_WIDTH);
                                                System.out.println();
                                                continue;
                                }
                                ...
                                if (newStatus == pc.getStatus()) {
                                        System.out.println();
                                        ConsoleUtils.printCenter(ConsoleUtils.YELLOW + "PC is already in " + pc.getStatus().getDescription() + " status! Please choose a different status." + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                                        ...
                                        ConsoleUtils.printLogoCentered(logo, ConsoleUtils.DEFAULT_WIDTH, 68);
                                        ConsoleUtils.printCenter(
                                                        ConsoleUtils.CYAN + "Update PC Status" + ConsoleUtils.RESET,
                                                        ConsoleUtils.DEFAULT_WIDTH);
                                        System.out.println();
                                        ConsoleUtils.printCenter(ConsoleUtils.CYAN + fullInfo + ConsoleUtils.RESET,
                                                        ConsoleUtils.DEFAULT_WIDTH);
                        ...
                        ConsoleUtils.printCenter(
                                        ...
                                        ConsoleUtils.DEFAULT_WIDTH);
                        ConsoleUtils.printCenter(
                                        ConsoleUtils.GREEN + "New Status: " + pc.getStatus().getDescription()
                                                        + ConsoleUtils.RESET,
                                        ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println(centerText(
                                        ConsoleUtils.YELLOW + "Press Enter to continue..." + ConsoleUtils.RESET,
        ...
        private void viewPCConfigDetail() {
                try {
                        ...
                        ConsoleUtils.printCenter(ConsoleUtils.CYAN + "━━━━━━━━ ＰＣ  ＣＯＮＦＩＧ  ＤＥＴＡＩＬＳ ━━━━━━━━" + ConsoleUtils.RESET, ConsoleUtils.DEFAULT_WIDTH);
                        System.out.println();
                        ...
                        if (configs != null && !configs.isEmpty()) {
                                ...
                                ConsoleUtils.printCenter(
                                                ConsoleUtils.YELLOW + "No PC configs found" + ConsoleUtils.RESET,
                                                ConsoleUtils.DEFAULT_WIDTH);
                        }
