...
INSERT INTO user (user_code, username, password, email, role_id, status) VALUES
('USER001', 'admin', '$2a$10$mU708.5ZIbZJnVBhQDq2Yen5yMd1AhAAv72Q69CBke4Q3yK5mzM5y', 'admin@cyber.com', 1, 'ACTIVE'),
('USER002', 'staff1', '$2a$10$mU708.5ZIbZJnVBhQDq2Yen5yMd1AhAAv72Q69CBke4Q3yK5mzM5y', 'staff@cyber.com', 2, 'ACTIVE'),
('USER003', 'customer1', '$2a$10$mU708.5ZIbZJnVBhQDq2Yen5yMd1AhAAv72Q69CBke4Q3yK5mzM5y', 'customer@cyber.com', 3, 'ACTIVE');
...
(1, 'Admin User', '0901234567', '123 Admin Street'),
...
INSERT INTO zone (zone_code, zone_name, price_multiplier) VALUES
('Z001', 'VIP Zone', 1.5),
...
INSERT INTO pc_config (config_code, cpu, ram, gpu, price_per_hour) VALUES
('CFG001', 'Intel i9', 32, 'RTX 4090', 150000.00),
...
INSERT INTO pc (pc_code, pc_name, zone_id, config_id, status) VALUES
('PC001', 'Gaming PC 1', 1, 1, 'AVAILABLE'),
...
INSERT INTO food_category (category_code, name, status) VALUES
('CAT001', 'Pizza', 'ACTIVE'),
...
-- ✅ SAMPLE FOOD DATA
INSERT INTO food_item (item_code, name, category_id, description, min_price, max_price, available_sizes, available_toppings, status) VALUES
('FD001', 'Margherita Pizza', 1, 'Classic pizza with tomato, mozzarella, and fresh basil', 150000, 250000, 'Small, Medium, Large', 'Extra Cheese, Pepperoni, Mushroom', 'ACTIVE'),
('FD002', 'Spicy Burger', 2, 'Juicy burger with spicy sauce and crispy fries', 80000, 120000, 'Regular, Large', 'Cheese, Bacon, Jalapeño', 'ACTIVE'),
...
INSERT INTO combo (combo_code, name, price, combo_items, status) VALUES
('CMB001', 'Family Pizza Combo', 500000.00, 'Margherita Pizza x2, Cola x2', 'ACTIVE'),
...
INSERT INTO combo_item (combo_id, item_id, quantity) VALUES
(1, 1, 2), (1, 3, 2),
(2, 2, 2), (2, 3, 1);
...
INSERT INTO wallet (wallet_code, user_id, balance) VALUES
('W001', 1, 5000000),
('W002', 2, 10000000),
('W003', 3, 500000);
...
CREATE TABLE payment (
    ...
    payment_code_generated VARCHAR(10) UNIQUE,
    FOREIGN KEY (booking_id) REFERENCES booking(booking_id),
    FOREIGN KEY (wallet_id) REFERENCES wallet(wallet_id),
...
-- ============================================
-- SELECT * FROM food_item LIMIT 5;
-- SELECT * FROM combo LIMIT 5;
-- DESCRIBE food_item;
